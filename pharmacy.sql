...
(
	...
	C_ID int(11),
	PRIMARY KEY (ID),
	CONSTRAINT doc_clinic_id FOREIGN KEY (C_ID) REFERENCES clinic(ID) ON DELETE SET NULL ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(
	...
	CONSTRAINT pres_pat_id FOREIGN KEY (PAT_SSN) REFERENCES patient(SSN) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT pres_med_id FOREIGN KEY (MED_ID) REFERENCES medication(ID) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT pres_doc_id FOREIGN KEY (DOC_ID) REFERENCES doctor(ID) ON DELETE CASCADE ON UPDATE CASCADE,
	PRIMARY KEY (ID)
...
(
	...
	CONSTRAINT pat_med_pat_id FOREIGN KEY (PAT_SSN) REFERENCES patient(SSN) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT pat_med_med_id FOREIGN KEY (DOC_ID) REFERENCES doctor(ID) ON DELETE CASCADE ON UPDATE CASCADE
